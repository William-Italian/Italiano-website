...
// حالة التقديم (مفتوح/مغلق) - محفوظة في ملف
const fs = require('fs');
...
app.post('/api/apply', async (req, res) => {
  ...
  const fields = [
    ...
    { name: '3️⃣ عدد الساعات', value: answers[2] || 'لم يجب', inline: true },
    { name: '4️⃣ المخالفات الإدارية', value: answers[3] || 'لم يجب', inline: true },
